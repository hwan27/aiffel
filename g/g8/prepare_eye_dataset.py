...
data_source_dir = os.getenv('HOME') + '/project/aiffel/g/g8/data/lfw/'
data_train_input_dir = os.getenv('HOME') + '/project/aiffel/g/g8/data/train/input/img/'
data_train_label_dir = os.getenv('HOME') + '/project/aiffel/g/g8/data/train/label/mask/'
data_val_input_dir = os.getenv('HOME') + '/project/aiffel/g/g8/data/val/input/img/'
data_val_label_dir = os.getenv('HOME') + '/project/aiffel/g/g8/data/label/mask/'
